...
_NotionAnd _$NotionAndFromJson(Map<String, dynamic> json) => $checkedCreate(
      '_NotionAnd',
      json,
      ($checkedConvert) {
...
_NotionOr _$NotionOrFromJson(Map<String, dynamic> json) => $checkedCreate(
      '_NotionOr',
      json,
      ($checkedConvert) {
        final val = _NotionOr(
      ...
      ($checkedConvert) {
        final val = NotionFormulaFilter(
          ...
          formula: $checkedConvert(
              'formula',
              (v) =>
                  NotionFormulaCondition.fromJson(v as Map<String, dynamic>)),
          $type: $checkedConvert('type', (v) => v as String?),
        );
        return val;
      },
      ...
      ($checkedConvert) {
        final val = NotionMultiSelectFilter(
          ...
          multiSelect: $checkedConvert(
              'multi_select',
              (v) => NotionMultiSelectCondition.fromJson(
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        final val = NotionNumberFilter(
          property: $checkedConvert('property', (v) => v as String),
          formula: $checkedConvert('formula',
      ...
      ($checkedConvert) {
        final val = NotionRelationFilter(
          ...
          relation: $checkedConvert(
              'relation',
              (v) =>
                  NotionRelationCondition.fromJson(v as Map<String, dynamic>)),
          $type: $checkedConvert('type', (v) => v as String?),
        );
        return val;
      },
      ...
      ($checkedConvert) {
        final val = NotionTimestampFilter(
          ...
          timestamp: $checkedConvert(
              'timestamp',
              (v) =>
                  NotionTimestampCondition.fromJson(v as Map<String, dynamic>)),
          $type: $checkedConvert('type', (v) => v as String?),
        );
        return val;
      },
      ...
      ($checkedConvert) {
        final val = NotionUniqueIdFilter(
          ...
          uniqueId: $checkedConvert(
              'unique_id',
              (v) =>
                  NotionUniqueIdCondition.fromJson(v as Map<String, dynamic>)),
          $type: $checkedConvert('type', (v) => v as String?),
        );
        return val;
      },
